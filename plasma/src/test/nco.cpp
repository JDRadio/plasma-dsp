...
TEST(nco, use_lookup_float)
{
    ...
    nco.set_frequency(0.00123);

    plasma::nco<float, plasma::no_lookup> nco_ref;
    nco_ref.set_frequency(0.00123);

    std::vector<float> vec(1024 * 2, 0.01);
    std::vector<float> vec_ref(1024 * 2, 0.01);
...
TEST(nco, use_lookup_double)
{
    ...
    static constexpr auto precision = 2e-5;
